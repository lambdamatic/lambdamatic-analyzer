...
public class SerializableFunctionExpressionBytecodeAnalyzerTest {
   ...
   */
  private static Object[] matchOnTestPojo(final SerializableFunction<TestPojo, ?> lambdaExpression,
   ...
   * @return an array containing the 2 arguments.
   */
  private static Object[] matchOnString(final SerializableFunction<String, ?> lambdaExpression,
      final Expression expression) {
    return new Object[] {lambdaExpression, expression};
  }
   ...
   * @return an array containing the 2 arguments.
   */
  private static Object[] match(final SerializableFunction<TestPojo, ?> lambdaExpression,
